...
//
// Common footer for every page. Single dark sky blue system. Full
// width. Lowercase. Clean content with no oxford commas and no dashes.
...
function Footer() {
  ...
  return (
    <footer className="relative pt-16 pb-10 w-full" style={{ background: "var(--color-bg)" }}>
      ...
      <Container size="full">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-14">
          <div className="md:col-span-6">
            ...
            <p className="text-body-sm text-ink-muted max-w-[42ch] leading-relaxed mt-5">A working compound in the San Juans. Sites, infrastructure and a council of working agents. Build deploy automate.</p>
