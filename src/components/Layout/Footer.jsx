...
//
// Common footer for every page. Single dark sky-blue system. The
// horizon hairline at the top edge is a 1px sky-blue seam. Minimal:
// the mark, a short line, coordinates, and a single contact.
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-14">
          <div className="md:col-span-6">
            ...
            <p className="text-body-sm text-ink-muted max-w-[42ch] leading-relaxed mt-5">
              A working compound in the San Juans. Sites, infrastructure, and a
              council of working agents. Build. Deploy. Automate.
            </p>
          ...
          <div className="md:col-span-3 md:col-start-10">
            ...
            <ul className="space-y-2.5">
              <li>
                  ...
                  className="text-body text-ink-muted hover:text-ink transition-colors duration-200"
                >
                  hello@neonburro.com
                </a>
              </li>
